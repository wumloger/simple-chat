				...
				<swiper-item v-for="(item, key) in emojiData" :key="key" class="slider-emoji">
					<u-row customStyle="flex-wrap: wrap;">
						<u-col span="1.5" v-for="(emoji, index) in item" customStyle="align-items: center;padding: 5px">
							<text :key="index" @click="selEmoji(emoji)" size="20" class="slider-emoji-icon"
								style="font-size: 20px">{{ emoji }}</text>
						</u-col>
					</u-row>
				</swiper-item>
			</swiper>
			...
			<view class="more-layer" :class="{hidden:hideMore}">
				<view class="list">
					<view class="box" @tap="getImage('album')">
						<view class="cuIcon-picfill text-blue" style="font-size: 50px"></view>
					</view>
					<view class="box" @tap="getImage('camera')">
						<view class="cuIcon-camerafill text-blue" style="font-size: 50px"></view>
					</view>
					<view class="box" @tap="getVideo('video')">
						<view class="cuIcon-videofill text-blue" style="font-size: 50px"></view>
					</view>
				</view>
			</view>
		</view>
		<!-- 底部输入栏 -->
		<view class="input-box cu-bar tabbar" :style="{bottom:bottom + 'upx'}" :class="popupLayerClass"
			@touchmove.stop.prevent="discard">
			<!-- H5下不能录音，输入栏布局改动一下 -->
			<!-- #ifndef H5 -->
			<view class="voice">
				<view class="text-gray" style="font-size: 28px" :class="isVoice?'cuIcon-keyboard':'cuIcon-voicefill'"
					@tap="switchVoice"></view>
			</view>
			<!-- #endif -->
			<!-- #ifdef H5 -->
			<view class="more" @tap="showMore">
				<view style="font-size: 30px" class="cuIcon-roundadd text-gray"></view>
			</view>
			<!-- #endif -->
			...
			<view class="send" :class="isVoice?'hidden':''">
				...
				<button type="default" class="btn" @touchend.prevent="sendText" style="font-size: 20upx;"><u-icon
						size="20" name="https://pic.imgdb.cn/item/65743d5dc458853aef8eb786.png"
						color="#ffffff"></u-icon></button>
			</view>
		</view>
		<!-- 录音UI效果 -->
		<view class="record" :class="recording?'':'hidden'">
			<view class="ing" :class="willStop?'hidden':''">
				<view class="cuIcon-notificationfill" style="font-size: 180upx;"></view>
			</view>
			<view class="cancel" :class="willStop?'':'hidden'">
				<view class="cuIcon-notificationforbidfill" style="font-size: 180upx;"></view>
			</view>
